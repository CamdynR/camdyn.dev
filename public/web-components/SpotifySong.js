...
class SpotifySong extends HTMLElement {
  ...
  constructor() {
    ...
    this.#ELEMS.songTitle = root.querySelector('#song-title');
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    switch (name) {
      ...
      case 'album-art-alt':
        ...
        break;
      case 'spotify-href':
        this.#ELEMS.songTitle.setAttribute('href', newValue);
        ...
        // Save Song
        let saveSong = newValue + '?intent=1';
        this.#ELEMS.saveOnSpotify.setAttribute('href', saveSong);
        this.#ELEMS.moreSaveOnSpotify.setAttribute('href', saveSong);
        break;
      case 'preview-src':
